...
1. Xcode에서 `ARBasket.xcodeproj`를 엽니다.
2. 실행할 iPhone 또는 iPad를 선택합니다.
3. Signing & Capabilities에서 개발 팀을 선택합니다.
4. 앱을 빌드하고 실행합니다.
5. 카메라를 벽에 향한 채 천천히 좌우로 움직입니다.
6. 초록색으로 표시된 벽 또는 ARKit이 추정한 벽을 탭해 골대를 배치합니다.
7. 화면을 위로 스와이프해 공을 던집니다.
